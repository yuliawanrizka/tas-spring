...
/*  Created On : 04-Oct-2017 16:39:31 				*/
/*  DBMS       : SQL Server 2008 						*/
/* ---------------------------------------------------- */

/* Drop Foreign Key Constraints */

IF EXISTS (SELECT 1 FROM dbo.sysobjects WHERE id = object_id(N'[FK_Achievement_Course]') AND OBJECTPROPERTY(id, N'IsForeignKey') = 1) 
ALTER TABLE [Achievement] DROP CONSTRAINT [FK_Achievement_Course]
GO

IF EXISTS (SELECT 1 FROM dbo.sysobjects WHERE id = object_id(N'[FK_Achievement_TrainingPeriod]') AND OBJECTPROPERTY(id, N'IsForeignKey') = 1) 
ALTER TABLE [Achievement] DROP CONSTRAINT [FK_Achievement_TrainingPeriod]
GO

IF EXISTS (SELECT 1 FROM dbo.sysobjects WHERE id = object_id(N'[FK_Achievement_UserRole]') AND OBJECTPROPERTY(id, N'IsForeignKey') = 1) 
ALTER TABLE [Achievement] DROP CONSTRAINT [FK_Achievement_UserRole]
GO

IF EXISTS (SELECT 1 FROM dbo.sysobjects WHERE id = object_id(N'[FK_Assessment_CoursePeriod]') AND OBJECTPROPERTY(id, N'IsForeignKey') = 1) 
ALTER TABLE [Assessment] DROP CONSTRAINT [FK_Assessment_CoursePeriod]
GO

IF EXISTS (SELECT 1 FROM dbo.sysobjects WHERE id = object_id(N'[FK_Assessment_EnrolledParticipants]') AND OBJECTPROPERTY(id, N'IsForeignKey') = 1) 
ALTER TABLE [Assessment] DROP CONSTRAINT [FK_Assessment_EnrolledParticipants]
GO

IF EXISTS (SELECT 1 FROM dbo.sysobjects WHERE id = object_id(N'[FK_Attendance_EnrolledParticipants]') AND OBJECTPROPERTY(id, N'IsForeignKey') = 1) 
ALTER TABLE [Attendance] DROP CONSTRAINT [FK_Attendance_EnrolledParticipants]
GO

IF EXISTS (SELECT 1 FROM dbo.sysobjects WHERE id = object_id(N'[FK_Attendance_Schedule]') AND OBJECTPROPERTY(id, N'IsForeignKey') = 1) 
ALTER TABLE [Attendance] DROP CONSTRAINT [FK_Attendance_Schedule]
GO
...
IF EXISTS (SELECT 1 FROM dbo.sysobjects WHERE id = object_id(N'[Assessment]') AND OBJECTPROPERTY(id, N'IsUserTable') = 1) 
...
(
	[assessmentId] bigint NOT NULL IDENTITY (1, 1),
	[enrolledParticipantsId] bigint NOT NULL,
...
CREATE NONCLUSTERED INDEX [IXFK_Achievement_Course] 
 ON [Achievement] ([courseId] ASC)
GO

CREATE NONCLUSTERED INDEX [IXFK_Achievement_TrainingPeriod] 
 ON [Achievement] ([term] ASC)
GO

CREATE NONCLUSTERED INDEX [IXFK_Achievement_UserRole] 
 ON [Achievement] ([userRoleId] ASC)
GO
...
CREATE NONCLUSTERED INDEX [IXFK_Assessment_CoursePeriod] 
 ON [Assessment] ([coursePeriodId] ASC)
GO

CREATE NONCLUSTERED INDEX [IXFK_Assessment_EnrolledParticipants] 
 ON [Assessment] ([enrolledParticipantsId] ASC)
GO
...
CREATE NONCLUSTERED INDEX [IXFK_Attendance_EnrolledParticipants] 
 ON [Attendance] ([enrolledParticipantsId] ASC)
GO

CREATE NONCLUSTERED INDEX [IXFK_Attendance_Schedule] 
 ON [Attendance] ([scheduleId] ASC)
GO
...
ALTER TABLE [Achievement] ADD CONSTRAINT [FK_Achievement_Course]
	FOREIGN KEY ([courseId]) REFERENCES [Course] ([courseId]) ON DELETE No Action ON UPDATE No Action
GO

ALTER TABLE [Achievement] ADD CONSTRAINT [FK_Achievement_TrainingPeriod]
	FOREIGN KEY ([term]) REFERENCES [TrainingPeriod] ([trainingPeriodId]) ON DELETE No Action ON UPDATE No Action
GO

ALTER TABLE [Achievement] ADD CONSTRAINT [FK_Achievement_UserRole]
	FOREIGN KEY ([userRoleId]) REFERENCES [UserRole] ([userRoleId]) ON DELETE No Action ON UPDATE No Action
GO

ALTER TABLE [Assessment] ADD CONSTRAINT [FK_Assessment_CoursePeriod]
	FOREIGN KEY ([coursePeriodId]) REFERENCES [CoursePeriod] ([coursePeriodId]) ON DELETE No Action ON UPDATE No Action
GO

ALTER TABLE [Assessment] ADD CONSTRAINT [FK_Assessment_EnrolledParticipants]
	FOREIGN KEY ([enrolledParticipantsId]) REFERENCES [EnrolledParticipants] ([enrolledParticipantsId]) ON DELETE No Action ON UPDATE No Action
GO

ALTER TABLE [Attendance] ADD CONSTRAINT [FK_Attendance_EnrolledParticipants]
	FOREIGN KEY ([enrolledParticipantsId]) REFERENCES [EnrolledParticipants] ([enrolledParticipantsId]) ON DELETE No Action ON UPDATE No Action
GO

ALTER TABLE [Attendance] ADD CONSTRAINT [FK_Attendance_Schedule]
	FOREIGN KEY ([scheduleId]) REFERENCES [Schedule] ([scheduleId]) ON DELETE No Action ON UPDATE No Action
GO
