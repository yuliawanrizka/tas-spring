...
/*  Created On : 22-Sep-2017 08:54:18 				*/
...
(
	[classroomId] bigint NOT NULL IDENTITY (0, 1),
...
CREATE TABLE [Course]
(
	[courseId] bigint NOT NULL IDENTITY (0, 1),
...
(
	[coursePeriodId] bigint NOT NULL IDENTITY (0, 1),
...
(
	[eligibleParticipantsId] bigint NOT NULL IDENTITY (0, 1),
	[trainingPeriodId] bigint NOT NULL,
...
(
	[employeeId] bigint NOT NULL IDENTITY (0, 1),
...
(
	[enrolledParticipantsId] bigint NOT NULL IDENTITY (0, 1),
...
CREATE TABLE [Grade]
(
	[gradeId] bigint NOT NULL IDENTITY (0, 1),
...
(
	[locationId] bigint NOT NULL IDENTITY (0, 1),
...
CREATE TABLE [Roles]
(
	[roleId] bigint NOT NULL IDENTITY (0, 1),
...
(
	[scheduleId] bigint NOT NULL IDENTITY (0, 1),
	[coursePeriodId] bigint NOT NULL,
	[date] date NOT NULL
)
GO
...
(
	[trainingPeriodId] bigint NOT NULL IDENTITY (0, 1),
...
(
	[userRoleId] bigint NOT NULL IDENTITY (0, 1),
